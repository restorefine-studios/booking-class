    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-4 max-w-5xl mx-auto">
        <div className=" backdrop-blur-sm p-8 rounded-3xl ">
          <h1 className="text-6xl md:text-8xl font-bold mb-2 bg-gradient-to-r from-[#ef5c28] via-[#7b1c11] to-[#ef5c28] bg-clip-text text-transparent animate-gradient-x">Move. Feel. Connect!</h1>

          <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl mx-auto leading-relaxed font-light">
            <span className="block text-white">Free yourself with the rhythm of Bollywood at the heart of Glasgow one choreo at a time.</span>
          </p>
