            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                <div className="relative">
                  <div className="w-250 h-30 bg-white rounded-2xl flex items-center justify-center shadow-2xl p-2 hover:shadow-3xl transition-all duration-300">
                    <Image src="/logo.svg" alt="Masala Moves Logo" width={150} height={100} className="transform hover:scale-105 transition-transform duration-300" />
                  </div>
